$(document).ready(function () {
	...
	$('#save').click(function () {
		...
		{
			confirm_text = 'Click OK to save the terms and conditions. Service providers will be required to agree to them before they can use Call It Quits.';
		}
		else
		{
			confirm_text = 'Click OK to disable terms and conditions. New service providers will not be required to agree to them.';
		}
