    ...
    <form action="" method="get">
        ...
        <table class="filter">
            ...
            <tr>
                ...
                <td><a href="/service-providers/monitoring-forms/ic-reports"><img src="/img/btn/clear.png" alt="Clear" /></a></td>
            </tr>
...
<h2>1B: Number of people setting a quit date by age, gender and outcome at <?php echo element('follow_up', $_GET, 4) ?> week follow up</h2>
...
<table class="stats">
    ...
    <tr>
    	<td class="no"></td>
        <td class="header">Refer to tier 3</td>
        <td><?php echo $ic['total_males_refer_to_tier_3']; ?></td>
        <td><?php echo $ic['males_under_18_refer_to_tier_3']; ?></td>
        <td><?php echo $ic['males_18_34_refer_to_tier_3']; ?></td>
        <td><?php echo $ic['males_35_44_refer_to_tier_3']; ?></td>
        <td><?php echo $ic['males_45_59_refer_to_tier_3']; ?></td>
        <td><?php echo $ic['males_60_and_over_refer_to_tier_3']; ?></td>
    </tr>
  	<tr class="subtitle">
    	<td class="no">
    	<td colspan="7">
    ...
    <tr>
    	<td class="no"></td>
        <td class="header">Refer to tier 3</td>
        <td><?php echo $ic['total_females_refer_to_tier_3']; ?></td>
        <td><?php echo $ic['females_under_18_refer_to_tier_3']; ?></td>
        <td><?php echo $ic['females_18_34_refer_to_tier_3']; ?></td>
        <td><?php echo $ic['females_35_44_refer_to_tier_3']; ?></td>
        <td><?php echo $ic['females_45_59_refer_to_tier_3']; ?></td>
        <td><?php echo $ic['females_60_and_over_refer_to_tier_3']; ?></td>
    </tr>
</table>

<h2>1C: Number of pregnant woman setting a quit date and outcome at <?php echo element('follow_up', $_GET, 4) ?> week follow up</h2>
