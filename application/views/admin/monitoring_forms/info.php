...
<div class="functions">
	...
	<?php if ( ! $pct_id): ?>
	<a href="/admin/monitoring-forms/set/<?php echo $monitoring_form['id'] ?>"><img src="/img/btn/update.png" alt="Update"></a>
	<?php endif; ?>

	<a href="?export=print" class="window"><img src="/img/btn/print.png" alt="Print" /></a>

	<a href="?delete=1" class="action" title="Click OK to delete this monitoring form and any associated claims."><img src="/img/btn/delete.png" alt="Delete" /></a>
...
<div class="item">
	...
	<table class="form" style="float:left;">
		...
		<tr>
			...
			<td><?php echo $service_provider['pct_name']; ?></td>
		</tr>
...
<div class="panel_right">
	...
	<div class="item">
		...
		<table class="form vat">
			...
			<tr>
				<th>Advisor</th>
				<td><?php echo element('advisor', $monitoring_form, 'N/A') ?></td>
			</tr>
	...
	<div class="item">
		...
		<table class="form vat">
			...
			<tr>
				...
				echo (count($hps) > 0) ? implode(', ', $hps) : 'None recorded';
				?></td>
			</tr>
...
<div class="item results">
	<?php if($monitoring_form['sms'] != 'Yes'): ?>
		<form action="/admin/monitoring-forms/info/<?= $monitoring_form['id']; ?>" method="post" id="new_message_form">
			<?php
...
<a href="/admin/monitoring-forms" class="back"><img src="/img/btn/back.png" alt="Back" /></a>
